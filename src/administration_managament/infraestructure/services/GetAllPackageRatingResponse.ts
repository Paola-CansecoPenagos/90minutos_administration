...
export class GetAllPackageRatingResponse {
    private queueName: string = process.env.RABBIT_QUEUE_GET_ALL_PACKAGE_RATING_RES_ADMINISTRATION || 'default';
    private exchangeName: string = process.env.RABBIT_EXCHANGE_ADMINISTRATION_EXCHANGE || 'default';
    private routingKey: string = process.env.RABBIT_ROUTING_KEY_GET_ALL_PACKAGE_RATING_RES_ADMINISTRATION || 'default';
